...
public class ValueTaskCancellationActionTests
{
    ...
    [Fact]
    public async Task ValueTaskCancellationAction_T1_T2_T3_T4_T5_WhenInvoked_ShouldCallActionOnce()
    {
        // Arrange
        var action = Substitute.For<Func<object, object, object, object, object, CancellationToken, ValueTask>>();
        var arg1 = new object();
        var arg2 = new object();
        var arg3 = new object();
        var arg4 = new object();
    ...
    [Fact]
    public async Task ValueTaskCancellationAction_T1_T2_T3_T4_T5_WhenTokenIsCanceled_ShouldThrowExceptionAndNotCallAction()
    {
        // Arrange
        var action = Substitute.For<Func<object, object, object, object, object, CancellationToken, ValueTask>>();
        var arg1 = new object();
    ...
    [Fact]
    public async Task ValueTaskCancellationAction_T1_T2_T3_T4_T5_T6_WhenInvoked_ShouldCallActionOnce()
    {
        // Arrange
        var action = Substitute.For<
            Func<object, object, object, object, object, object, CancellationToken, ValueTask>
        >();
        var arg1 = new object();
        var arg2 = new object();
        var arg3 = new object();
    ...
    [Fact]
    public async Task ValueTaskCancellationAction_T1_T2_T3_T4_T5_T6_WhenTokenIsCanceled_ShouldThrowExceptionAndNotCallAction()
    {
        // Arrange
        var action = Substitute.For<
            Func<object, object, object, object, object, object, CancellationToken, ValueTask>
    ...
    [Fact]
    public async Task ValueTaskCancellationAction_T1_T2_T3_T4_T5_T6_T7_WhenInvoked_ShouldCallActionOnce()
    {
        // Arrange
        var action = Substitute.For<
            Func<object, object, object, object, object, object, object, CancellationToken, ValueTask>
        >();
        var arg1 = new object();
        var arg2 = new object();
        var arg3 = new object();
    ...
    [Fact]
    public async Task ValueTaskCancellationAction_T1_T2_T3_T4_T5_T6_T7_WhenTokenIsCanceled_ShouldThrowExceptionAndNotCallAction()
    {
        // Arrange
        var action = Substitute.For<
            Func<object, object, object, object, object, object, object, CancellationToken, ValueTask>
    ...
    [Fact]
    public async Task ValueTaskCancellationAction_T1_T2_T3_T4_T5_T6_T7_T8_WhenInvoked_ShouldCallActionOnce()
    {
        // Arrange
        var action = Substitute.For<
            Func<object, object, object, object, object, object, object, object, CancellationToken, ValueTask>
        >();
        var arg1 = new object();
        var arg2 = new object();
        var arg3 = new object();
    ...
    [Fact]
    public async Task ValueTaskCancellationAction_T1_T2_T3_T4_T5_T6_T7_T8_WhenTokenIsCanceled_ShouldThrowExceptionAndNotCallAction()
    {
        // Arrange
        var action = Substitute.For<
            Func<object, object, object, object, object, object, object, object, CancellationToken, ValueTask>
