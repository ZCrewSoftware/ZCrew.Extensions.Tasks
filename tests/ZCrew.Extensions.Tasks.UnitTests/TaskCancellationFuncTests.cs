...
public class TaskCancellationFuncTests
{
    ...
    [Fact]
    public async Task TaskCancellationFunc_T1_T2_T3_T4_T5_WhenInvoked_ShouldCallFuncOnce()
    {
        // Arrange
        var func = Substitute.For<Func<object, object, object, object, object, CancellationToken, Task<object>>>();
        var arg1 = new object();
        var arg2 = new object();
        var arg3 = new object();
        var arg4 = new object();
    ...
    [Fact]
    public async Task TaskCancellationFunc_T1_T2_T3_T4_T5_WhenTokenIsCanceled_ShouldThrowExceptionAndNotCallFunc()
    {
        // Arrange
        var func = Substitute.For<Func<object, object, object, object, object, CancellationToken, Task<object>>>();
        var arg1 = new object();
    ...
    [Fact]
    public async Task TaskCancellationFunc_T1_T2_T3_T4_T5_T6_WhenInvoked_ShouldCallFuncOnce()
    {
        // Arrange
        var func = Substitute.For<
            Func<object, object, object, object, object, object, CancellationToken, Task<object>>
        >();
        var arg1 = new object();
        var arg2 = new object();
        var arg3 = new object();
    ...
    [Fact]
    public async Task TaskCancellationFunc_T1_T2_T3_T4_T5_T6_WhenTokenIsCanceled_ShouldThrowExceptionAndNotCallFunc()
    {
        // Arrange
        var func = Substitute.For<
            Func<object, object, object, object, object, object, CancellationToken, Task<object>>
    ...
    [Fact]
    public async Task TaskCancellationFunc_T1_T2_T3_T4_T5_T6_T7_WhenInvoked_ShouldCallFuncOnce()
    {
        // Arrange
        var func = Substitute.For<
            Func<object, object, object, object, object, object, object, CancellationToken, Task<object>>
        >();
        var arg1 = new object();
        var arg2 = new object();
        var arg3 = new object();
    ...
    [Fact]
    public async Task TaskCancellationFunc_T1_T2_T3_T4_T5_T6_T7_WhenTokenIsCanceled_ShouldThrowExceptionAndNotCallFunc()
    {
        // Arrange
        var func = Substitute.For<
            Func<object, object, object, object, object, object, object, CancellationToken, Task<object>>
    ...
    [Fact]
    public async Task TaskCancellationFunc_T1_T2_T3_T4_T5_T6_T7_T8_WhenInvoked_ShouldCallFuncOnce()
    {
        // Arrange
        var func = Substitute.For<
            Func<object, object, object, object, object, object, object, object, CancellationToken, Task<object>>
        >();
        var arg1 = new object();
        var arg2 = new object();
        var arg3 = new object();
    ...
    [Fact]
    public async Task TaskCancellationFunc_T1_T2_T3_T4_T5_T6_T7_T8_WhenTokenIsCanceled_ShouldThrowExceptionAndNotCallFunc()
    {
        // Arrange
        var func = Substitute.For<
            Func<object, object, object, object, object, object, object, object, CancellationToken, Task<object>>
